...
export function SquareIconButton(props: SquareIconButtonProps) {
	...
	return (
		<Dynamic
			...
			classList={{
				'bg-theme-base-600 text-theme-base-200 hover:enabled:border-theme-base-600 hover:enabled:bg-theme-base-600 disabled:text-theme-base-200':
					theme() === 'light',
				'bg-theme-base-600  text-theme-base-100 hover:enabled:border-theme-base-600 hover:enabled:bg-theme-base-600':
					theme() === 'dark',
			}}
